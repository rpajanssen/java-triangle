...
This example project will demonstrate some bad exception handling examples in your REST 
resources.
...
What if you have different implementations and you switch to another implementation by
only changing the configuration that does not use the java persistence api?
